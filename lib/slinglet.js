...
function Completer(id, label, width, dataset, dataset_labels, dataset_ids, dataset_weights) {
  ...
  if (this.constructor.name == 'Completer') {
    ...
    inp.bind('paste', util.bind(this.inputHandlerPasteCutBindme, this));
    inp.bind('cut', util.bind(this.inputHandlerPasteCutBindme, this));
  }
...
Completer.prototype.inputHandlerPasteCutBindme = function (event) {
  this.requestFillTable(false);
};
