...
hoplax.bookmark_completer.emptyAction = function() {
  util.load("lib/help.js",
    function() {
      ...
      // TODO(baldvin): lose focus of the input box somehow, so the
      // user can scroll the help
    });
};
 ...
 */
hoplax.bookmark_completer.inputui.focus(function() {
...
hoplax.init2 = function() {
  ...
  hoplax.bookmark_completer.inputui.focusin(); // chrome bug
};
